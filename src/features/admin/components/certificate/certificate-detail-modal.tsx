...
import { useCertificateDetailQuery } from '@/features/admin/hooks/use-reviews'
import {
  REVIEW_AUTH_STATUS,
...
export function CertificateDetailModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={open => !open && onClose()}>
      <DialogContent className="h-[calc(100vh-6rem)] w-[calc(100vw-2rem)] max-w-none overflow-y-auto md:h-[calc(90vh-6rem)] md:w-[calc(100vw-4rem)] md:max-w-none md:h-[calc(80vh-6rem)] md:w-[calc(85vw-4rem)] lg:w-[calc(70vw-4rem)] xl:w-[calc(60vw-4rem)]">
        <DialogHeader>
