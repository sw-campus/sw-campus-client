  ...
  return (
    <div className="block w-full">
      <Link
        ...
        className={`group flex w-full gap-3 rounded-xl border p-3 shadow-sm transition-all duration-200 active:scale-[0.99] sm:gap-4 sm:p-4 sm:hover:-translate-y-0.5 sm:hover:shadow-lg ${
          post.pinned 
      ...
      <div className="flex min-w-0 flex-1 flex-col justify-between">
        ...
        <div>
          ...
          <h3 className={`line-clamp-1 text-base font-semibold transition-colors group-hover:text-orange-600 sm:text-lg ${
            post.pinned ? 'text-gray-900' : 'text-gray-900'
          }`}>
             {post.title}
          </h3>
        ...
        <div className="mt-2 flex items-center justify-between text-xs text-gray-500 sm:text-sm">
          ...
          <div className="flex items-center gap-3 text-xs">
            ...
            <span className={`flex items-center gap-1 ${isPopular ? 'text-red-500 font-medium' : ''}`}>
