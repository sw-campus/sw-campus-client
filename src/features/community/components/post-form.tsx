  ...
  return (
    <>
      <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-5 sm:space-y-6">
        {/* 카테고리 선택 - Step 1 */}
        <div className="relative rounded-2xl border-2 border-primary/30 bg-gradient-to-br from-primary/5 to-white p-4 shadow-sm transition-all hover:border-primary/40 hover:shadow-md sm:p-5">
          {/* 단계 표시 */}
