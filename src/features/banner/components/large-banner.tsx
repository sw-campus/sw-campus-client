...
import { useBannerBackgroundStore } from '@/store/banner-background.store'
...
export default function LargeBanner() {
  ...
  if (isLoading) {
    return (
      <div className="bg-muted flex h-[180px] items-center justify-center overflow-hidden md:h-[220px]">
