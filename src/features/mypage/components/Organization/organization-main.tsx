...
import { ApprovalFilter } from '@/features/admin/components/common/approval-filter'
import { ApprovalPagination } from '@/features/admin/components/common/approval-pagination'
import { APPROVAL_STAT_COLORS, ColorfulStatCard } from '@/features/admin/components/common/colorful-stat-card'
import {
  APPROVAL_STATUS,
...
import LectureEditModal from '@/features/mypage/components/Organization/lecture-edit-modal'
import { OrganizationCard } from '@/features/mypage/components/Organization/organization-card'
import ReviewListModal from '@/features/mypage/components/Organization/review-list-modal'
