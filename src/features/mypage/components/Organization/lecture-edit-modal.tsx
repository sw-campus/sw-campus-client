...
import { useUpdateLectureMutation } from '@/features/lecture/hooks/use-update-lecture-mutation'
import type { LectureResponseDto } from '@/features/lecture/types/lecture-response.type'
import { mapLectureDetailToFormValues } from '@/features/lecture/utils/map-lecture-detail-to-form-values'
