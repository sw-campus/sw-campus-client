      ...
      <section className="relative flex min-h-[540px] w-full items-center justify-center rounded-3xl px-8 py-10">
        ...
        <div className="relative z-10 flex w-full items-center justify-center">
          ...
          >
            ...
            {/* 회사명 */}
            <div className="mb-4">
              <label className="mb-1 block text-[11px] text-neutral-700">회사명</label>
              <input
                type="text"
                placeholder="office"
                className="h-9 w-full rounded-md border border-neutral-300 bg-neutral-100 px-3 text-[11px] outline-none focus:border-neutral-500 focus:bg-white"
            ...
            {/* 직무 */}
            <div className="mb-4">
              <label className="mb-1 block text-[11px] text-neutral-700">직무</label>
              <input
                type="text"
                placeholder="job"
                className="h-9 w-full rounded-md border border-neutral-300 bg-neutral-100 px-3 text-[11px] outline-none focus:border-neutral-500 focus:bg-white"
            ...
            {/* 재직증명서 + 인증 */}
            <div className="mb-4">
              <label className="mb-1 block text-[11px] text-neutral-700">재직증명서</label>
              <div className="flex gap-2">
                <input
                  type="text"
                  placeholder="images"
