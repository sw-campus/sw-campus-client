  ...
  return (
    <div className="mx-auto flex w-full max-w-4xl flex-col items-stretch px-4 py-6 md:px-6 md:py-8">
      ...
      <div className="mb-6 w-full self-stretch overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-gray-100 md:mb-8 md:rounded-3xl">
        {/* 커버 이미지 */}
        <div className="relative h-24 bg-primary md:h-40">
          <div className="absolute inset-0 bg-[url('/grid.svg')] opacity-10" />
          <div className="absolute -bottom-1 left-0 right-0 h-12 bg-linear-to-t from-white to-transparent" />
        </div>
              ...
              <div className="w-full pt-12 md:pt-20">
                ...
                <div className={`mt-4 grid w-full rounded-xl bg-gray-50 py-3 md:mt-6 md:rounded-2xl md:py-4 ${isOwnProfile ? 'grid-cols-3' : 'grid-cols-2'}`}>
                  <div className="flex flex-col items-center justify-center border-r border-gray-200">
                    <p className="text-xl font-bold text-primary md:text-2xl">{formatNumber(profile.postCount)}</p>
