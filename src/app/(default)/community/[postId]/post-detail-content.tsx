...
export default function PostDetailContent({ postId, initialData }: PostDetailContentProps) {
  ...
  if (error || !post) {
    ...
    return (
      <main className="relative mx-auto flex w-full max-w-7xl flex-1 flex-col gap-4 overflow-x-hidden py-6 md:px-6 md:py-8 md:px-8">
        <div className="mx-auto flex w-full flex-col items-center justify-center rounded-2xl border border-dashed border-gray-200 bg-linear-to-b from-gray-50/50 to-white py-20 lg:max-w-3xl">
    ...
    <main className="relative mx-auto flex w-full max-w-7xl flex-1 flex-col gap-4 overflow-x-hidden py-6 md:px-6 md:py-8 md:px-8">
      ...
      <article className="overflow-hidden border-y border-gray-200/60 bg-white shadow-sm md:rounded-3xl md:border">
        ...
        <header className="p-4 pb-0 md:p-8 md:pb-0">
          ...
          {/* 제목 */}
          <h1 className="mb-5 text-xl leading-snug font-bold tracking-tight text-gray-900 md:mb-6 md:text-2xl lg:text-3xl">
            {post.title}
          </h1>
        ...
        {/* 구분선 */}
        <div className="mx-4 my-4 h-px bg-gradient-to-r from-transparent via-gray-200 to-transparent md:mx-8 md:my-6" />
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 md:justify-start">
              ...
              <div className="flex gap-2">
                <div className="flex">
                  <button
                    onClick={() => toggleLike()}
                    disabled={isLiking}
                    className={`flex h-10 items-center justify-center gap-2 rounded-l-xl border text-sm font-medium transition-all active:scale-95 px-3 md:px-4 ${
                      post.isLiked
                ...
                <button
                  ...
                  className={`flex h-10 items-center justify-center gap-2 rounded-xl border text-sm font-medium transition-all active:scale-95 px-3 md:px-4 ${
                    post.isBookmarked
              ...
              {userType === 'ADMIN' && (
                ...
                >
                  ...
                  <span className="hidden md:inline">{post.pinned ? '고정 해제' : '공지 고정'}</span>
                </button>
              )}
