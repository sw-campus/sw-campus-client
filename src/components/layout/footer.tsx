...
export default function Footer() {
  ...
  return (
    <>
      ...
      <footer className="mx-auto mb-6 hidden w-full max-w-7xl rounded-2xl border border-gray-200 bg-white/60 p-6 text-gray-800 shadow-lg backdrop-blur-xl sm:mb-10 sm:rounded-3xl sm:p-8 md:block md:p-10">
        {/* 상단 영역 */}
